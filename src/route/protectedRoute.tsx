 ...
 */
const ProtectedRoute = ({ component: Component, validator, fallBack, ...rest }: ProtectedRouteProps & RouteProps) => (
  <Route {...rest} render={props => (validator ? <Component {...props} /> : <Redirect to={fallBack} />)} />
);
